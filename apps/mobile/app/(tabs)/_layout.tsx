...
export default function TabLayout() {
  ...
  return (
    <Tabs
      // The custom AppBottomNavigation (mounted once at the root layout)
      // always renders now, signed in or not - this built-in tab bar must
      // stay hidden unconditionally to avoid showing both.
      tabBar={() => null}
      screenOptions={{
