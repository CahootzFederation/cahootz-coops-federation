  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      <div className="mx-auto flex min-h-screen max-w-2xl flex-col items-center justify-center px-6 py-16 text-center">
        ...
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Choose a commons page</h1>
        <p className="mt-4 text-base text-slate-300">
          Public commons pages live at addresses like <span className="font-mono text-slate-100">/c/cahootz</span>.
        </p>
        <div className="mt-8">
