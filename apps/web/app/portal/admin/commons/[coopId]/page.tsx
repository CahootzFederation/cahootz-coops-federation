      ...
      {commons && (
        <>
          ...
          <div className="flex flex-wrap gap-3">
            <Link href={`/portal/admin/commons/${commons.coopId}/stores`} className="inline-flex rounded-md border border-emerald-300/30 bg-emerald-300/10 px-4 py-2 text-sm font-semibold text-emerald-100 hover:bg-emerald-300/20">
              View all stores →
            </Link>
            ...
            <Link href={`/portal/admin/commons/${commons.coopId}/welcome-tables`} className="inline-flex rounded-md border border-orange-300/30 bg-orange-300/10 px-4 py-2 text-sm font-semibold text-orange-100 hover:bg-orange-300/20">
              Welcome lounges →
            </Link>
          </div>
